...
def fetch_and_generate():
   # rss_url = "https://news.google.com/rss/search?q=son+dakika&hl=tr&gl=TR&ceid=TR:tr"
     rss_url = "https://news.google.com/rss/search?q=gundem+OR+dunya+OR+ekonomi+OR+teknoloji+OR+spor+OR+saglik+OR+bilim+OR+%22son+dakika%22&hl=tr&gl=TR&ceid=TR:tr"
